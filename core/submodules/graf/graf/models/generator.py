...
from core.submodules.nerf_pytorch.run_nerf_mod import render, run_network            # import conditional render
...
class Generator(nn.Module):
    def __init__(self, H, W, focal, radius, ray_sampler, render_kwargs_train, render_kwargs_test, parameters, named_parameters,
        ...
        self.generator = self.render_kwargs_train['network_fn']
        self.generator_fine = self.render_kwargs_train['network_fine']
