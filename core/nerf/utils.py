...
def sample_full_xys(batch_size, img_size):
    half_pix_width = 1.0 / img_size
    half_pix_height = 1.0 / img_size
    grid_min_x=1.0 - half_pix_width
    grid_max_x=-1.0 + half_pix_width
    grid_min_y=1.0 - half_pix_height
    grid_max_y=-1.0 + half_pix_height
